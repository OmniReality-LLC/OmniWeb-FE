...
import EngravedText from '../../shared/atomicStrings/EngravedText/component'
...
export default function Service({ section, topShadow }: { section: Section, topShadow: boolean }) {
    ...
    const shadowData = {
        ...
        topOnly: '0 -2px 5px rgba(255, 255, 255, 0.1), 0 2px 5px rgba(0, 0, 0, 1)',

    }

    return (
        <div className=''>
            <div className={`${styles.titleTextContainer}`}  style={{boxShadow: shadowData.topOnly}}>
            <EngravedText text={'This Is A Title'} className={styles.myTitle}/>
            </div>
