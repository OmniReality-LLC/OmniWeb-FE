            ...
            <div className={`${styles.footerContainer} container`}>
                ...
                <div className={`${styles.buttonCol} col`}>
                    <div className={`${styles.footerRow} d-flex justify-content-start`}>
                        <SlideGlowLinkBtn className={styles.myButton} text={'Schedule Call'} linkTo={'https://calendly.com/omnireality/free-consultation'} marginL='0' textColor='#D4D4D4' defaultStyle={false} target="_blank" rel="noopener noreferrer" />
