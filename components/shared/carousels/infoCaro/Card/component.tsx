        ...
        <div className={styles.mainCardHolder}>
            <div className={`${styles.embossContainer}`}>
                <div className={` row`}>
                    ...
                    <div className={`${styles.imgContainer} col-3`}>
                ...
                <div className={styles.btnContainer}>
                    <SlideGlowLinkBtn text={'View'} linkTo={''} marginL='0' defaultStyle={false}  className={styles.myButton}   marginB='2.5%' marginT='10%'/>
                </div>
            </div>
        </div>
    )
