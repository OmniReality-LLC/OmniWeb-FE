...
const benefitsData = {
    ...
    benefits: [
        ...
        { name: "Content Updates", infoIcon: true, info: "Leverage dedicated hours every month for design and development amendments, keeping your content fresh and relevant.", tierCutoff: true },
        { name: "OmniDesk", infoIcon: true, info: "Harness the power of OmniDesk, providing live analytics, AI enhancements, and real-time support capabilities.", tierCutoff: false },
        {
            name: "AI Add-Ons",
            infoIcon: true,
            info: "Enhance your platform with our AI Add-Ons. Employ CLARA for 24/7 chat support, generate SEO-rich content with AI Copywriter, and beautify images with AI PhotoMaster. Our intelligent tools are designed to seamlessly boost user experience and operational efficiency.",
            tierCutoff: false
        }
        ,
    ...
    tiers: [
        {
            ...
            benefits: [
                ...
                { name: "Add-Ons", included: false, content: 'CHECKBOX' },
        ...
        },
        {
            ...
            benefits: [
                ...
                { name: "Add-Ons", included: true, content: 'CHECKBOX' },
